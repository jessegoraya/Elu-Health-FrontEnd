...
exports.createStore = function () {
    ...
    }), redux_1.applyMiddleware(redux_observable_1.createEpicMiddleware(redux_observable_1.combineEpics(updateSelectedActivity, sendMessage, trySendMessage, retrySendMessage, showTyping, sendTyping, speakSSML, speakOnMessageReceived, startListening, stopListening, stopSpeaking, listeningSilenceTimeout))));
};
